...
Mini Sessions FAQs belong to each campaign. They are created with the approved
starter questions and can be edited, reordered, added, or removed in the
dashboard. They appear only on the active Mini Sessions page.
