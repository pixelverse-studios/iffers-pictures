...
- Prepared the portfolio image data for CMS-driven media management.
...
- DEV-915: Moved portfolio image records into a typed JSON media catalog with published-status filtering and compatibility exports for existing pages.
