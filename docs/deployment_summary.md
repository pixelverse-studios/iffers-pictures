...
- Added a theme switcher widget (bottom-left corner) for previewing 5 color palettes and switching between heading and body fonts — available on every page of the site
