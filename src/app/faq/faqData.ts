...
export const generalFaqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Yes, we offer flexible payment options. A deposit is required at booking to secure your date, with the remaining balance due before or on the day of your session. Contact us to discuss what works best for you.",
  },
  {
    question: "Can I request specific shots or poses?",
    answer:
      "Absolutely! We encourage you to share inspiration photos, Pinterest boards, or a shot list before your session. While we'll guide you through natural poses, we love incorporating your vision into the final collection.",
  },
];
