...
const CARD_ACCENTS: Record<string, string> = {
  events: "from-[var(--coral)]/10 to-[var(--coral)]/5",
  family: "from-[var(--teal)]/10 to-[var(--teal)]/5",
  milestones: "from-[var(--gold)]/10 to-[var(--gold)]/5",
  headshots: "from-[var(--text-muted)]/10 to-transparent",
  maternity: "from-[var(--coral)]/8 to-transparent",
};
