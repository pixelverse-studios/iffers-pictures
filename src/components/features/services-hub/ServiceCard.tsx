    ...
    >
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute top-4 left-4 flex items-center justify-center w-10 h-10 rounded-full bg-white/90 backdrop-blur-sm shadow-lg">
          <IconComponent className="w-5 h-5 text-[var(--brand)]" />
        </div>
      ...
      <div className="p-5">
        ...
        {/* CTA */}
        <div className="flex items-center gap-2 text-[var(--brand)] font-medium text-sm">
      ...
      {/* Hover Accent Line */}
      <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-[var(--brand)] scale-x-0 origin-left transition-transform duration-300 group-hover:scale-x-100" />
    </Link>
  );
}
