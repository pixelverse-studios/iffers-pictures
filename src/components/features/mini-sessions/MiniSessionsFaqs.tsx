...
import { miniSessionFaqSchema } from "@/lib/mini-sessions/types";
...
export function MiniSessionsFaqs({
  ...
  return (
    <section
      ...
      className="border-t border-[var(--border)] bg-[var(--background-warm)] py-12 md:py-16"
    >
        ...
        <div className="border-t border-[var(--border)]">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              <div className="mini-rich-content pb-7 pl-10 pr-10 text-base leading-8 text-[var(--text-secondary)] md:pr-16" dangerouslySetInnerHTML={{ __html: faq.answerHtml }} />
            </details>
          ))}
        </div>
      </div>
