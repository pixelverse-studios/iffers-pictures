  ...
  return (
    <div className="bg-[var(--background)] pt-16 md:pt-[72px]">
      ...
      <section className="overflow-hidden bg-[var(--background)]">
        <div className="board-shell grid md:min-h-[660px] md:grid-cols-[0.92fr_1.08fr]">
          ...
          <div className="hero-reveal relative left-1/2 min-h-[360px] w-screen -translate-x-1/2 overflow-hidden md:left-auto md:min-h-full md:w-auto md:translate-x-0" style={revealStyle(180)}>
            {heroImage && (
              <Image
                src={heroImage.src}
                alt={heroImage.alt}
            ...
            <div className="absolute inset-0 hidden bg-gradient-to-r from-[var(--background)] via-[var(--background)]/42 to-transparent md:block" />
          </div>
        </div>
      </section>
